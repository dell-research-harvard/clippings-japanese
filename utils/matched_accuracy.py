...
def calculate_matched_accuracy(matched_results = "DATAFRAME/FOR/CALCULATE/ACCURACY", match_ground_truth = "/path/to/data/record_linkage_clean_dataset/ground_truth/truth_TK_partnerpath_2_titlepath_0314.json", \
    match_test_subset = "/path/to/data/record_linkage_clean_dataset/test_paths.json", source_image_path = "/path/to/data/record_linkage_clean_dataset/pr_partner_crop_36673/"):
