...
def prepare_data(
    ground_truth_pr_tk="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/japan_pr_tk/TK_matched.csv",
    ground_truth_pr_pr="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/japan_pr_tk/PR_matched.csv",
    pr_partners_data="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/yxm/homo_match_dataset/japan/partners.json",
    tk_data='/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/yxm/homo_match_dataset/japan/effocr_tk_title.json',
    pr_title_data='/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/yxm/homo_match_dataset/japan/effocr_pr_title.json',
):
    ...
    ground_truth_source_images=ground_truth_pr_tk['source'].tolist()
    ground_truth_target_images=ground_truth_pr_tk['target'].tolist()

    ##Get the text for each source and target
    ground_truth_source_text=[subdict['partner_text'] for subdict in pr_partners_data if subdict['partner_path'] in ground_truth_source_images]
    ground_truth_target_text=[sublist[0] for sublist in tk_data if sublist[1] in ground_truth_target_images]

    ###Get the corresponding paths and make a df
    ground_truth_source_paths=[subdict['partner_path'] for subdict in pr_partners_data if subdict['partner_path'] in ground_truth_source_images]
    ground_truth_target_paths=[sublist[1] for sublist in tk_data if sublist[1] in ground_truth_target_images]
    ...
    ##Get OCR text for both source and target. source and target contain paths - simply get the text from path list for each data
    ground_truth_source_images=ground_truth_pr_pr['source'].tolist()
    ground_truth_target_images=ground_truth_pr_pr['target'].tolist()

    ##Get the text for each source and target
    ground_truth_source_text=[sublist[0] for sublist in pr_title_data if convert_to_text(sublist[1]) in ground_truth_source_images]
    ground_truth_target_text=[sublist[0] for sublist in pr_title_data if convert_to_text(sublist[1]) in ground_truth_target_images]

    ###Get the corresponding paths and make a df
    ground_truth_source_paths=[sublist[1] for sublist in pr_title_data if sublist[1] in ground_truth_source_images]
    ground_truth_target_paths=[sublist[1] for sublist in pr_title_data if sublist[1] in ground_truth_target_images]
    ...
    ###Save both the dfs
    ground_truth_pr_tk.to_csv("/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/TK_matched_ocr.csv", index=False,encoding='utf-8-sig')
    ground_truth_pr_pr.to_csv("/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_matched_ocr.csv", index=False,encoding='utf-8-sig')
    ...
    ##Save the df
    text_only_pr_tk_pr.to_csv("/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_TK_matched_ocr.csv", index=False, encoding='utf-8-sig')
...
def prep_labelled_data(
    data_path= "/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_TK_matched_ocr.csv",
    test_viz_linkage="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/japan_pr_tk_v2/splits/test_paths_final.json",
    output_path="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_TK_matched_ocr_only_train.csv"    
):
    ...
    ###Subset the dataframe to only contain everythng but the test set
...
def prep_labeled_test_data(
    data_path= "/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_TK_matched_ocr.csv",
    test_viz_linkage="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/japan_pr_tk_v2/splits/test_paths_final.json",
    output_path="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_TK_matched_ocr_only_test.csv"    
):
    ...
    data_long=data_long[data_long['image_path'].str.contains("dot_dect_1130/element_crop/")]
...
def make_data_with_hardnegs(
    train_df,
    output_path="/mnt/122a7683-fa4b-45dd-9f13-b18cc4f4a187/PaddleOCR_testing/Paddle_test_images/multimodal_data/PR_TK_matched_ocr_hardnegs.csv",
    k=8,
    batch_size=128,
    m=4,
    model=None,
